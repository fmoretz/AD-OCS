...
in order to reach the desired H2S concentration in the effluent. Thus, it will increase the influent oxygen without limits.'''
...
for i in range(0, len(t)-1):#   
    ...
    while True: 
        ...
        if x_out['H2S'][i+1]*1e+6 > H2S_treshold: 
            ...
            F_in['O2'][i-1] = F_in['O2'][i-1]*1.2 # Increase O2 influent to have a larger concentration of O2 in the headspace at t=i -> r_SOB[i] can  be increased
...
# digester_out['efficiency'] = (1-digester_out['F_H2S']/digester_out['F_H2S_in'])*100
