...
plt.figure(figsize=(20,10))
plt.subplot(2,1,1)
plt.plot(digester_out['t']/24, digester_out['x_v_CH4'], label='$CH_4$')
...
plt.legend()
plt.xlim([digester_out['t'].min()/24, digester_out['t'].max()/24])
plt.xticks(rotation=45)
plt.subplot(2,1,2)
plt.plot(digester_out['t']/24, digester_out['x_v_H2S']*1e+6, label='$H_2S$')
# plt.plot(digester_out['t'], digester_out['x_v_O2']*1e+6, label='$O_2$')
plt.legend()
plt.xlim([digester_out['t'].min()/24, digester_out['t'].max()/24])
plt.xticks(rotation=45)
