...
from models import AD_OCS_2, AMOCO_HN
...
YOUT1 = odeint(AD_OCS_2, y0, np.linspace(0,3,500), hmax = (t_span_d[1]-t_span_d[0]), args=(alfa, mu_max, Ks, KI2, KH, Pt, kLa, D, k, kd, N_bac, N_S1, y0[2], t_span[0], y_in_0, T3.index.values, t_span_d))

y0 = YOUT1[-1,:] # use the initial condition from the results of the previous integration

YOUT= odeint(AD_OCS_2, y0, t_span_d, hmax = (t_span_d[1]-t_span_d[0]), args=(alfa, mu_max, Ks, KI2, KH, Pt, kLa, D, k, kd, N_bac, N_S1, y0[2], t_span[0], y_in_0, T3.index.values, t_span_d))
