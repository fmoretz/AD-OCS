...
XT_SS   = XT_in_0*D/(D+k[6])

X1_SS   = (D*(S1_in_0 - S1_SS) + k[6]*XT_SS)/(k[0]*mu1_SS)
X2_SS   = 1/(k[2]*mu2_SS)*(D*(S2_in_0 - S2_SS) + k[1]/k[0]*(D*(S1_in_0 - S1_SS) + k[6]*XT_SS))
...
epsi    = D*(C_in_0 + S2_SS - Z_SS) + k[3]*mu1_SS*X1_SS + k[4]*mu2_SS*X2_SS
