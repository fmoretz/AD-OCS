...
def setInfluent(i):
    global S_su_in, S_aa_in, S_fa_in, S_va_in, S_bu_in, S_pro_in, S_ac_in, S_h2_in,S_ch4_in, S_IC_in, S_IN_in, S_I_in,X_xc_in, X_ch_in,X_pr_in,X_li_in,X_su_in,X_aa_in,X_fa_in,X_c4_in,X_pro_in,X_ac_in,X_h2_in,X_I_in,S_cation_in,S_anion_in, Q_in
    ##variable definition
    ...
    Q_in = influent_state['Q'][i] #m^3.d^-1
...
pH = -np.log10(S_H_ion) # initial pH
...
S_nh4_ion = 0.057517059 #kmole N.m^-3 the initial value is from Rosen et al (2006) BSM2 report and it is calculated further down and does not need to be initiated
S_co2 = 0.01 #kmole C.m^-3 the initial value is from Rosen et al (2006) BSM2 report and it is calculated further down and does not need to be initiated
...
#q_ad =  V_liq/HRT #m^3.d^-1 initial flow rate (can be modified during the simulation by the control algorithm) ======================================================================
...
def DAESolve():
  ...
  S_h2delta = 1.0
  S_h2gradeq = 1.0
  tol = 10 ** (-8) #solver accuracy tolerance
...
initflow = {'q_gas': [0], 'q_ch4': [0], 'q_co2' :[0], 'q_h2' :[0], 'p_gas' : [0], 'p_gas_h2' : [0], 'p_gas_ch4' : [0], 'p_gas_co2' : [0]}
...
for u in t[1:]:
  ...
  state_input = [S_su_in,S_aa_in,S_fa_in,S_va_in,S_bu_in,S_pro_in,S_ac_in,S_h2_in,S_ch4_in,S_IC_in,S_IN_in,S_I_in,X_xc_in,X_ch_in,X_pr_in,X_li_in,X_su_in,X_aa_in,X_fa_in,X_c4_in,X_pro_in,X_ac_in,X_h2_in,X_I_in,S_cation_in,S_anion_in, Q_in]
  ...
  flowtemp = {'q_gas' : q_gas, 'q_ch4' : q_ch4, 'q_co2' : q_co2, 'q_h2' : q_h2, 'p_gas' : p_gas, 'p_gas_h2' : p_gas_h2, 'p_gas_ch4' : p_gas_ch4, 'p_gas_co2' : p_gas_co2}
